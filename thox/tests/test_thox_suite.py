"""Static contract tests for the THOX Hermes product layer.

This suite lives outside the upstream ``tests/`` tree so the upstream autouse
server fixture is not started for static product-layer validation.
"""
